...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupAdapter() {
        EmployeeAdapter adapter = new EmployeeAdapter(this, mEmployees);
    ...
    private class EmployeeAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                view = mInflater.inflate(R.layout.employee_item, parent, false);
            ...
            for (String skill : skills) {
                ...
                TextView skillView = (TextView) mInflater.inflate(R.layout.skill_item,
    ...
    private static class SkillColor {
        ...
        public static Integer getSolidColorBySkill(String skill) {
            ...
            if (color == null) color = skillColorShape.get("default");
        ...
        public static Integer getStrokeColorBySkill(String skill) {
            ...
            if (color == null) color = skillColorStroke.get("default");
